...
FOUR_PLAYER_OPENING_FAILSAFE_START = 6
FOUR_PLAYER_OPENING_FAILSAFE_END = 38
FOUR_PLAYER_OPENING_FAILSAFE_PROD_CEILING = 24
...
def plan_moves(world, deadline=None):
    ...
    def run_four_player_opening_failsafe():
        ...
        for src in sources:
            ...
            sent_count += 1
            if sent_count >= FOUR_PLAYER_OPENING_FAILSAFE_MAX_PER_TURN:
                return
