...
def build_policy_state(world, deadline=None):
    ...
    for planet in world.my_planets:
        ...
        first_enemy_eta = world.first_enemy_map.get(planet.id)
        no_immediate_hit = first_enemy_eta is None or first_enemy_eta > 8
        if (
            no_immediate_hit
            ...
            and (
                world.my_prod <= 10
                or world.my_total <= world.max_enemy_strength * 1.05
            )
        ):
